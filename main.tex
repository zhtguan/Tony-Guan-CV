...
\begin{center}
    \small{
  \href{https://zhtguan.github.io/}{ Personal Website}|+1-617-784-6900 | 
...
\resumeProject
  {Implicit Regularization and Dynamic Gain  Control}
  {Advisor: Prof. Jiahao Chen}
  {Sep. 2023- Jan. 2024}
    {{}[\href{https://pypi.org/project/emachinery/}{\textcolor{darkblue}{\faGithub}}]}
\resumeItemListStart
 \item Presented a Bezier Curve-based nonlinear controller for improved tracking, efficiency, and disturbance rejection. 
 \item Proposed an open-source package for simulation and hardware deployment. 
  \item Proposed feasibility criteria using Sturm’s theorem, and Multi-Objective Optimization for fine tunning.
  \item Proposed online numerical realization on embedded system using Brent's Method.
 \item Proposed online control-point adapting using implicit regularization, sum-of-square.
 \item This work is prepared for IEEE Transactions on Power Electronics Letter.
 
\resumeItemListEnd

\resumeProject
  {\textbf{Sensor Autonomy for Insect-Scale Robots (Ongoing)}}
  {Advisor: Prof. Kevin Chen}
  {July. 2024- Present}
    {{}}
\resumeItemListStart
 \item Presented sensing-autonomy on insect scale robots.  
 \item Presented PCB fabrication and components selection under 200-mg weight.
\resumeItemListEnd
...
\vspace{-0.4mm}
 \resumeHeadingSkillStart
  \resumeSubItem{Programming Languages: }
    ...
    \resumeSubItem{\textcolor{Research: }{Control Theory and its Application, Sensing, and Mechatronic Design }
